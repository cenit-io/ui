...
function DateCondition({ value, disabled, onChange }) {
  ...
  let inputs;
  if (condition.o === 'default') {
    inputs = <DateTimePicker value={condition.v[0] ? new Date(condition.v[0]) : null}
                             ...
                             slotProps={{
                               textField: {
                                 variant: "standard",
                                 placeholder: condition.v[0] ? undefined : "?"
                               }
                             }} />
  } else if (condition.o === 'between') {
    inputs = (
      <>
        <DateTimePicker value={condition.v[1] ? new Date(condition.v[1]) : null}
        ...
        <DateTimePicker value={condition.v[2] ? new Date(condition.v[2]) : null}
                        ...
                        slotProps={{
                          textField: {
                            variant: "standard",
                            placeholder: condition.v[2] ? undefined : "∞"
                          }
                        }} />
      </>
    );
