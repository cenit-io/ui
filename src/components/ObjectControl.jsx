    ...
    const subscription = formConfigProperties(
      ...
      setState({
        ...
        orchestrator: config?.orchestrator || (
          ...
          (editMode ? sConfig?.actions?.edit?.orchestrator : sConfig?.actions?.new?.orchestrator)
        ) || sConfig?.orchestrator,
        dynamicConfig: config?.dynamicConfig || (
          // TODO can be new with rootId in EmbedsManyControl
          (editMode ? sConfig?.actions?.edit?.dynamicConfig : sConfig?.actions?.new?.dynamicConfig)
