...
export default function GatewayFilledIcon(props) {
  return (
    <SvgIcon {...props}>
      ...
      <path d="M23.21,19.71H15.42A3.51,3.51,0,0,0,12.75,17V12.33a.44.44,0,0,0-.44-.44h-.62a.44.44,0,0,0-.44.44V17a3.51,3.51,0,0,0-2.67,2.67H.79a.75.75,0,1,0,0,1.5H8.58a3.5,3.5,0,0,0,6.84,0h7.79a.75.75,0,0,0,0-1.5Z"/>
    </SvgIcon>
  );
}
