...
export default function ObjectFilledIcon(props) {
  return (
    <SvgIcon {...props}>
      ...
      <path d="M21.47,17.82a.26.26,0,0,0-.4-.23c-1.35.83-4.38,1.94-9.07,1.94s-7.72-1.11-9.07-1.94a.26.26,0,0,0-.4.23v3c0,1.72,4.24,3.11,9.47,3.11s9.47-1.39,9.47-3.11Z"/>
    </SvgIcon>
  );
}
